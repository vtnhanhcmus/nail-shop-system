...
--
-- Host: 127.0.0.1    Database: nail-shops
-- ------------------------------------------------------
...
CREATE TABLE `product_detail` (
  ...
  `product_detail_id` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `shop_detail` (
  ...
  `update_date` datetime DEFAULT NULL,
  `shop_id` int(11) DEFAULT NULL,
  `shop_detail_id` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_profile` (
  ...
  `user_profile_id` varchar(100) DEFAULT NULL,
  `insert_user` int(11) DEFAULT NULL,
  `insert_date` datetime DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `working_times_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `employee_id` int(11) NOT NULL,
  `employee_work_time_id` int(11) NOT NULL,
...
-- Dump completed on 2020-11-22 16:39:57
